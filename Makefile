...
CS333_TPROGS += _testsetuid  _testuidgid _testuidgid_mod _p2-test
endif

ifeq ($(CS333_PROJECT), 3)
CS333_CFLAGS += -DCS333_P1 -DUSE_BUILTINS -DCS333_P2 -DCS333_P3
CS333_UPROGS += _date _time _ps
CS333_TPROGS += _p2-test _testsetuid _testuidgid _p3-test
endif

ifeq ($(CS333_PROJECT), 4)
CS333_CFLAGS += -DCS333_P1 -DUSE_BUILTINS -DCS333_P2 -DCS333_P3 -DCS333_P4
CS333_UPROGS += _date _time _ps
CS333_TPROGS += _p2-test _testsetuid _testuidgid _p3-test _p4-test _mlfq
endif
